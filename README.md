...
+ ### How to run:
    - ###### As long as your computer has installed Java JRE, the project already is an executable jar file executable on Mac, Windows, and Linux. 
...
## [SQL Project][SQL]
### [PostgreSQL][SQL]
Here are some PostgreSQL, SQL, and Python scripts.  <u>Click on the title link for more project details.</u>
